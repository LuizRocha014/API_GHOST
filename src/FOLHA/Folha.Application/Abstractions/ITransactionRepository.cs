...
{
    Task<IReadOnlyList<Transaction>> GetAllByUserAsync(Guid userId, int skip, int take, DateTime? modifiedSince = null, CancellationToken cancellationToken = default);
